...
import { renderCareModePage } from '@/legacy-runtime/components/bloomIntelligence';
...
import {
  ...
  isRestModeActive,
} from '@/lib/services/careModeService';
import { isDiscreteMode, setDiscreteMode } from '@/lib/utils/discreteMode';
