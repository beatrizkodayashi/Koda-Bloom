...
} from '@/lib/services/dailyLogService';
...
import { getMoodOptions, periodContinueLabel } from '@/lib/utils/genderLanguage';
import {
  upsertPeriodEntry,
  getCycleStarts,
  getPeriodEntries,
...
import { buildSmartFollowUp } from '@/lib/services/bloomIntelligenceService';
import { analyzeMultipleSymptoms } from '@/lib/services/bloomPhase2Service';
import { renderSmartFollowUpBanner } from '@/legacy-runtime/components/bloomIntelligence';
import { renderIsThisNormalInline } from '@/legacy-runtime/components/bloomPhase2';
...
import { todayString, addDays } from '@/lib/utils/dates';
