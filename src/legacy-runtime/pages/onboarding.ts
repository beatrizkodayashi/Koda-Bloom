// @ts-nocheck
import { APP_NAME, DEFAULTS, HEALTH_DISCLAIMER, ROUTES } from '@/lib/config/app';
import { navigate } from '@/lib/navigation';
import { getState, setState } from '@/lib/state/store';
import { upsertProfile, upsertPeriodEntry, saveOnboardingProgress } from '@/lib/services/cycleService';
import { savePreferences, getDefaultPreferences } from '@/lib/services/dailyLogService';
